...
public class CounselorService {
    ...
    public Page<AppointmentResponse> getAllAppointmentForCounselor(Pageable pageable) {
        User user = userCommonService.getUser();

        Page<CounselorAppointment> counselorAppointmentsPage = counselorAppointmentRepository
        ...
        return counselorAppointmentsPage.map(appointmentMapper::toAppointmentResponse);
    }
